...
def createDB():
    ...
    if os.path.exists("main.db"):
        ...
        cur.execute("INSERT INTO studentCardIDs (student_email, card_id) VALUES ('coateslachlan@inaburrastudents.nsw.edu.au', '5CEF083E')")
        cur.execute("INSERT INTO studentCardIDs (student_email, card_id) VALUES ('greeneisaac@inaburrastudents.nsw.edu.au', '6C7C413E')")
        cur.execute("INSERT INTO studentCardIDs (student_email, card_id) VALUES ('parkharry@inaburrastudents.nsw.edu.au', 'ACFF293E')")
        cur.execute("INSERT INTO studentCardIDs (student_email, card_id) VALUES ('feodoroffdaniel@inaburrastudents.nsw.edu.au', 'FCFA293E')")
